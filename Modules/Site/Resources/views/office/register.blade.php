...
<div class="container">
    <div class="row  justify-content-center " style="margin-bottom: 80px">
        <div class="col-12 register-description text-center">
            <h4><b>درخواست سرویس دفاتر پیشخوان دولت</b></h4>
            <p>
                بر اساس ابلاغیه شماره ۱۰۰/۱۵۱۳۱ بند ۷، ریاست محترم سازمان تنظیم و مقررات ارتباطات رادیویی هرگونه تراکنش مالی و دریافت هزینه خدمات، بایستی از طریق تجهیزات یکی از pspهای دارای مجوز از بانک مرکزی اقدام گردد لذا بر اساس قرارداد همکاری با شرکت به پرداخت ملت می بایست کلیه دفاتر پیشخوان دولت را به دستگاه پیسی پوز pc-pos مجهز نماید میزان حق الزحمه دفتر در خدمات دولتی با توجه به ابلاغیه های نرخ گذاری سازمان تنظیم و مقررات خواهد بود و در خدمات غیر دولتی بصورت تفکیک در هر خدمت قبل از فعالسازی آن خدمت برای دفتر اعلام خواهد شد تبصره 1: در تمامی خدمات حق الزحمه دفتر بصورت تسهیم آنلاین و در حساب دفتر با توجه به قوانین بانک مرکزی واریز خواهد شد تبصره 2: با توجه به تسهیم آنلاین بودن حق السهم خدمات مدیر دفتر آگاهی کامل دارد که برروی دستگاههای یوز نصب شده در دفتر حسابهای مختلف دولتی و غیر دولتی تعریف شده است و رضایت خود را برای تسهیم خدمات اعلام میدارد بر این اساس از کلیه همکاران محترم خواهشمندیم در صورت داشتن دستگاه پوز بانک ملت (جهت بروزرسانی ) و یا نداشتن آن (جهت ارايه دستگاه جدید ) ، فرم ذیل را تکمیل تا فرایند ارایه خدمات تسریع گردد.
            </p>
            <p>
                جهت ارتباط با مرکز پشتیبانی لطفا با شماره تلفن تماس حاصل نمایید
            </p>
        ...
        <div class="col-12 register-form">
            ...
            <form action="{{route('offices.store')}}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4 ">
                        <label style="display: block" >تصویری از جساب بانکی</label>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4 ">
                        ...
                        <a href="#" target="_blank" class="btn btn-warning upload-btn">دانلود تعهد نامه<i class="fa fa-upload mr-2" aria-hidden="true"></i></a>
                    </div>
